 ...
 * </p>
 * <ul>
 *   <li>{@link robot.ev3.dls.impl.ExpressionPlusImpl#getSub <em>Sub</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionPlusImpl extends IntExpressionImpl implements ExpressionPlus
{
  ...
  {
    return DlsPackage.Literals.EXPRESSION_PLUS;
  }
  ...
  public NotificationChain basicSetSub(IntExpression newSub, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DlsPackage.EXPRESSION_PLUS__SUB, oldSub, newSub);
  ...
  public void setSub(IntExpression newSub)
  {
    if (newSub != sub)
    {
      ...
      if (sub != null)
        msgs = ((InternalEObject)sub).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DlsPackage.EXPRESSION_PLUS__SUB, null, msgs);
      if (newSub != null)
        msgs = ((InternalEObject)newSub).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DlsPackage.EXPRESSION_PLUS__SUB, null, msgs);
      msgs = basicSetSub(newSub, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DlsPackage.EXPRESSION_PLUS__SUB, newSub, newSub));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DlsPackage.EXPRESSION_PLUS__SUB:
